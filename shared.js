  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between h-16">
      <div class="flex items-center">
        <a href="index.html" class="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400">ExoLiX</a>
      </div>
      <div class="flex items-center space-x-6">
        <a href="explorer.html" class="nav-link text-gray-300 hover:text-blue-400 transition" data-page="explorer">Explorer</a>
        <a href="mapping.html" class="nav-link text-gray-300 hover:text-blue-400 transition" data-page="mapping">Mapping</a>
        <a href="training.html" class="nav-link text-gray-300 hover:text-blue-400 transition" data-page="training">Training</a>
      </div>
    </div>
  </div>
</nav>
